...
export default function SignIn(updateLocalStorage) {
  ...
  return (
    <AppTheme toggle={toggle} toggleBtn={toggleBtn} register={register}>
        ...
        <Card variant="outlined">
          ...
          >
            ...
            <FormControlLabel
              ...
              label="Remember me"
            />
            <ForgotPassword open={open} handleClose={setPassword} />
            <ForgotEmail open={open} handleClose={setEmail} />
            <Button
              type="submit"
              fullWidth
              variant="contained"
